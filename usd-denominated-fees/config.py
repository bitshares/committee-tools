...
native_fees = {  #####################################################
    ...
    #
    "transfer": {"fee": 0.08, "price_per_kbyte": 0.03},
    #####################################################
    #####################################################
    # ORDER OPERATIONS
    #####################################################
    ...
    #                 up this
    #
    "asset_issue": {"fee": 0.05, "price_per_kbyte": 0.03},
    #####################################################
    #
    # Description:
    #
    ...
    #
    "asset_update": {"fee": 1, "price_per_kbyte": 0.03},
    #####################################################
    #
    # Description:
    #
    ...
    #
    "asset_publish_feed": {"fee": 0.00001},
    #####################################################
    #
    # Description:
    #
    ...
    #
    "account_update": {"fee": 0.003, "price_per_kbyte": 0.03},
    #####################################################
    #
    # Description:
    #
    ...
    #
    "account_create": {"basic_fee": 0.25, "premium_fee": 3, "price_per_kbyte": 0.03},
    #####################################################
    #####################################################
    # VESTING OPERATIONS
    #####################################################
    ...
    #
    "vesting_balance_withdraw": {"fee": 1},
    #####################################################
    #####################################################
    # WORKER OPERATIONS
    #####################################################
    ...
    "proposal_create": {"fee": 0.2, "price_per_kbyte": 0.15},
    #####################################################
    #
    # Description:
    #
    ...
    #
    "proposal_update": {"fee": 0.02, "price_per_kbyte": 0.03},
    #####################################################
    #####################################################
    ...
    # Update 11/2018:
    #
    "committee_member_create": {"fee": 50},
    #####################################################
    #
    # Description:
    #
    ...
    # Update 11/2018:
    #
    "transfer_to_blind": {"fee": 0.4, "price_per_output": 0.07},
    #####################################################
    #####################################################
    ...
    #                 valuable
    "withdraw_permission_create": {"fee": 0.5},
    #####################################################
    #
    # Description:
    #
    ...
    # Update 11/2018:
    #
    "withdraw_permission_update": {"fee": 0.05},
    #####################################################
    #
    # Description:
    #
    ...
    # Update 11/2018:
    #
    "withdraw_permission_claim": {"fee": 0.1, "price_per_kbyte": 0.03},
    #####################################################
    #
    # Description:
    #
    ...
    #
    "custom": {"fee": 0.005, "price_per_kbyte": 0.05},
    #####################################################
    #
    # Description:
    #
    ...
    #
    "override_transfer": {"fee": 2, "price_per_kbyte": 0.03},
    #####################################################
    # Virtual
    "fba_distribute": {},
    #####################################################
